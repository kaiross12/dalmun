...
.navbar.scrolled .nav-container { backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); background: #ffffff15; box-shadow: 0 10px 40px rgba(0, 0, 0, 0.08); transform: translateZ(0); }
